  ...
  const loadSessions = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log(
          "📋 Sessions loaded, user can choose to start a new session"
        );
      }
    } catch (error) {
    ...
    try {
      ...
      voiceService.initializeRecognition({
        ...
        onResult: (data) => {
          ...
          const fullContent = existingMessage
            ? existingMessage + " " + newContent
            : newContent;
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 overflow-hidden">
            ...
            <div className="flex flex-col h-[600px] items-center justify-center p-12">
              <div className="text-center max-w-md">
                ...
                <p className="text-gray-300 mb-8 leading-relaxed">
                  Your voice session is prepared and ready. Click the button
                  below to start the conversation and begin your reflection
                  journey.
                </p>
          ...
          {activeTab === "chat" && sessionId && !showStartConversation && (
            <div className="flex flex-col h-[600px]">
              ...
              {sessionType === "voice" &&
                (isSpeaking || isStreaming || wasStopped) && (
                            ...
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-orange-200 text-xs mt-1">
                                  Your recording was interrupted. You have{" "}
                                  {currentMessage.length} characters saved.
                                </p>
