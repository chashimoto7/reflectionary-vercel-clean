    ...
    <div className="max-w-7xl mx-auto p-6">
              ...
              {showPrivacyInfo && (
                <div className="absolute right-0 top-12 w-80 bg-slate-800 border border-white/20 rounded-lg shadow-lg p-4 z-10">
                  <p className="text-sm text-gray-300">
                    ...
                    progress are private and only visible to you. AI analysis is
                    performed on encrypted data without exposing content.
                  </p>
                </div>
              )}
            </div>
      ...
      {showEditModal && selectedGoal && (
        <EditGoalModal
          ...
          onSave={(updatedData) => handleEditGoal(selectedGoal.id, updatedData)}
        />
      )}
